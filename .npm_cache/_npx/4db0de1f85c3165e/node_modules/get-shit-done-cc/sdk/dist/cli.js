...
export async function main(argv = process.argv.slice(2)) {
    ...
    if (args.command === 'query') {
        ...
        try {
            ...
            if (!matched) {
                throw new GSDError(`Unknown command: "${tokens.join(' ')}". Use a registered \`gsd-sdk query\` subcommand (see sdk/src/query/QUERY-HANDLERS.md) or invoke \`node …/gsd-tools.cjs\` for CJS-only operations.`, ErrorClassification.Validation);
            }
