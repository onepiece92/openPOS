...
export const verifyKeyLinks = async (args, projectDir) => {
    ...
    for (const link of keyLinks) {
        ...
        if (!sourceContent) {
            ...
            const regex = regexForKeyLinkPattern(linkObj.pattern);
 ...
 */
export const validateConsistency = async (_args, projectDir) => {
 ...
 */
export const validateHealth = async (args, projectDir) => {
            ...
            for (const ref of phaseRefs) {
                ...
                if (!diskPhases.has(ref) && !diskPhases.has(normalizedRef) && !diskPhases.has(String(parseInt(ref, 10)))) {
                    if (diskPhases.size > 0) {
                        addIssue('warning', 'W002', `STATE.md references phase ${ref}, but only phases ${[...diskPhases].sort().join(', ')} exist`, 'Review STATE.md manually');
                    }
                }
            }
        }
