 ...
 */
async function readModifyWriteStateMd(projectDir, modifier) {
 ...
 */
export const stateUpdate = async (args, projectDir) => {
    const field = args[0];
    const value = args[1];
 ...
 */
export const statePatch = async (args, projectDir) => {
 ...
 */
export const stateBeginPhase = async (args, projectDir) => {
 ...
 */
export const stateAdvancePlan = async (_args, projectDir) => {
    const today = new Date().toISOString().split('T')[0];
 ...
 */
export const stateRecordMetric = async (args, projectDir) => {
    const phase = args[0];
    const plan = args[1];
 ...
 */
export const stateUpdateProgress = async (_args, projectDir) => {
 ...
 */
export const stateAddDecision = async (args, projectDir) => {
 ...
 * @returns QueryResult with { added: true/false }
 */
export const stateAddBlocker = async (args, projectDir) => {
 ...
 */
export const stateResolveBlocker = async (args, projectDir) => {
 ...
 * @returns QueryResult with { recorded: true/false }
 */
export const stateRecordSession = async (args, projectDir) => {
...
// ─── statePlannedPhase ────────────────────────────────────────────────────
export const statePlannedPhase = async (args, projectDir) => {
