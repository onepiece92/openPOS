...
import { normalizePhaseName, toPosixPath } from './helpers.js';
// ─── Internal helpers ──────────────────────────────────────────────────────
/**
 ...
 */
async function getPhaseInfoWithFallback(phase, projectDir) {
 ...
 */
export const initExecutePhase = async (args, projectDir) => {
    const phase = args[0];
    if (!phase) {
 ...
 */
export const initPlanPhase = async (args, projectDir) => {
    const phase = args[0];
    if (!phase) {
 ...
 */
export const initPhaseOp = async (args, projectDir) => {
    const phase = args[0];
    if (!phase) {
