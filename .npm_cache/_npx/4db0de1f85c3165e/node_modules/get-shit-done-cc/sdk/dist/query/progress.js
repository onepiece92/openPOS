 ...
 */
export async function determinePhaseStatus(plans, summaries, phaseDir) {
    if (plans === 0)
        return 'Pending';
 ...
 */
export const progressJson = async (_args, projectDir) => {
...
// ─── progressBar ─────────────────────────────────────────────────────────
export const progressBar = async (_args, projectDir) => {
...
// ─── statsJson ───────────────────────────────────────────────────────────
export const statsJson = async (_args, projectDir) => {
