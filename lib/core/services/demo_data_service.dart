...
class DemoDataService {
  ...
  Future<void> seed() async {
    ...
    final productRows = [
      // Croissants & Pastries
      ('CRO001', 'Butter Croissant',       120.0, 999, 'Croissants & Pastries'),
      ('CRO002', 'Almond Croissant',       175.0, 999, 'Croissants & Pastries'),
      ('CRO003', 'Croissant',              225.0, 999, 'Croissants & Pastries'),
      ('CRO004', 'Small Croissant',        100.0, 999, 'Croissants & Pastries'),
      ('CRO005', 'Small Frozen Croissant',  80.0, 999, 'Croissants & Pastries'),
      ('CRO006', 'Pain au Chocolat',       135.0, 999, 'Croissants & Pastries'),
      // Eclairs
      ('ECL001', 'Chocolate Eclair',  100.0, 999, 'Eclairs'),
      ('ECL002', 'Vanilla Eclair',    100.0, 999, 'Eclairs'),
      ('ECL003', 'Banana Eclair',     125.0, 999, 'Eclairs'),
      ('ECL004', 'Blueberry Eclair',  100.0, 999, 'Eclairs'),
      ('ECL005', 'Flavoured Eclair',  100.0, 999, 'Eclairs'),
      // Tarts & Pies
      ('TAR001', 'Fruit Tart',                125.0, 999, 'Tarts & Pies'),
      ('TAR002', 'Apple Tart',                125.0, 999, 'Tarts & Pies'),
      ('TAR003', 'Almond Chocolate Tart',     125.0, 999, 'Tarts & Pies'),
      ('TAR004', 'Almond Blackcurrant Tart',  125.0, 999, 'Tarts & Pies'),
      ('TAR005', 'Almond Apple Tart',         125.0, 999, 'Tarts & Pies'),
      ('TAR006', 'Almond Blueberry Tart',     125.0, 999, 'Tarts & Pies'),
      ('TAR007', 'Custard Pie',               125.0, 999, 'Tarts & Pies'),
      ('TAR008', 'Apple Crumble Pie',         125.0, 999, 'Tarts & Pies'),
      ('TAR009', 'Strawberry Pie',            150.0, 999, 'Tarts & Pies'),
      ('TAR010', 'Mango Pie',                 125.0, 999, 'Tarts & Pies'),
      ('TAR011', 'Mango Pie (Whole)',        1000.0, 999, 'Tarts & Pies'),
      ('TAR012', 'Lemon Tart',                100.0, 999, 'Tarts & Pies'),
      ('TAR013', 'Mille-Feuille',             150.0, 999, 'Tarts & Pies'),
      ('TAR014', 'Mulberry Tart (Whole)',    1000.0, 999, 'Tarts & Pies'),
      // Breads & Buns
      ('BRD001', 'Multigrain Bread',          180.0, 999, 'Breads & Buns'),
      ('BRD002', 'Sourdough Bread',           330.0, 999, 'Breads & Buns'),
      ('BRD003', 'Multigrain Sourdough Bread',380.0, 999, 'Breads & Buns'),
      ('BRD004', 'Focaccia',                   90.0, 999, 'Breads & Buns'),
      ('BRD005', 'Small Baguette',             75.0, 999, 'Breads & Buns'),
      ('BRD006', 'Long Baguette',             100.0, 999, 'Breads & Buns'),
      ('BRD007', 'Multigrain Baguette',       100.0, 999, 'Breads & Buns'),
      ('BRD008', 'Banana Bread (Slice)',      100.0, 999, 'Breads & Buns'),
      ('BRD009', 'Burger Bun',                 25.0, 999, 'Breads & Buns'),
      ('BRD010', 'Panini Bread',               40.0, 999, 'Breads & Buns'),
      ('BRD011', 'Breakfast Bun',              40.0, 999, 'Breads & Buns'),
      // Savouries
      ('SAV001', 'Quiche',                 150.0, 999, 'Savouries'),
      ('SAV002', 'Chicken Patty',          100.0, 999, 'Savouries'),
      ('SAV003', 'Veg Patty',               90.0, 999, 'Savouries'),
      ('SAV004', 'Burger Patty',           100.0, 999, 'Savouries'),
      ('SAV005', 'Chicken Burger Patty',   110.0, 999, 'Savouries'),
      ('SAV006', 'Sausage Roll',           100.0, 999, 'Savouries'),
      ('SAV007', 'Sausage Roll (Large)',   200.0, 999, 'Savouries'),
      ('SAV008', 'Bread Pudding',           80.0, 999, 'Savouries'),
      ('SAV009', 'Puffed Dough',           600.0, 999, 'Savouries'),
      // Cakes & Sweets
      ('CAK001', 'Brownie',        120.0, 999, 'Cakes & Sweets'),
      ('CAK002', 'Caramel Cake',   950.0, 999, 'Cakes & Sweets'),
      ('CAK003', 'Apple Strudel',  125.0, 999, 'Cakes & Sweets'),
      ('CAK004', 'Custom Order',     0.0, 999, 'Cakes & Sweets'),
    ];
